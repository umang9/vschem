...
<html lang="zxx">
	<head>
		...
		<title>Vschem Tutorials - Learning Website</title>	
		...
		<link rel="stylesheet" href="{{asset('app/vendor/font-awesome/css/fontawesome-all.min.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/animate/animate.min.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/linear-icons/css/linear-icons.min.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/owl.carousel/assets/owl.carousel.min.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/owl.carousel/assets/owl.theme.default.min.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/magnific-popup/magnific-popup.min.css')}}">

		<!-- Theme CSS -->
		<link rel="stylesheet" href="{{asset('app/css/theme.css')}}">
		<link rel="stylesheet" href="{{asset('app/css/theme-elements.css')}}">

		<!-- Current Page CSS -->
		<link rel="stylesheet" href="{{asset('app/vendor/rs-plugin/css/settings.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/rs-plugin/css/layers.css')}}">
		<link rel="stylesheet" href="{{asset('app/vendor/rs-plugin/css/navigation.css')}}">
		...
		<!-- Head Libs -->
		<script src="{{asset('app/vendor/modernizr/modernizr.min.js')}}"></script>

	</head>
	<body>
		<div class="body">
			<header id="header" class="header-effect-reveal header-transparent" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 170, 'stickySetTop': '0px'}">
						...
						<div class="header-row">
							<div class="header-column justify-content-start">
								<div class="header-logo">
									<a href="index.html">
										<img alt="EZ" width="75" height="50" src="{{asset('app/img/logo-small.png')}}">
									</a>
								</div>
							</div>
								...
								<div class="header-nav">
									...
									<div class="header-button d-none d-sm-flex ml-3">
                                        @if(is_null(\Auth::user()))
                                            <a href="{{url('/login')}}" class="btn btn-outline btn-rounded btn-primary btn-4 btn-icon-effect-1" target="_blank">
                                                <span class="wrap">
                                                    <span>LOGIN</span>
                                        ...
                                        @else
                                            <a href="{{url('/dashboard')}}" class="btn btn-outline btn-rounded btn-primary btn-4 btn-icon-effect-1" target="_blank">
                                                <span class="wrap">
                                                    <span>Dashboard</span>
                                                    <i class="fas fa-pencil"></i>
                                                </span>
                                    ...
                                    <div class="header-button d-none d-sm-flex ml-3">
                                        <a href="{{url('/student/register')}}" class="btn btn-outline btn-rounded btn-primary btn-4 btn-icon-effect-1" target="_blank">
                                            <span class="wrap">
                                                <span>Register</span>
                                                <i class="fas fa-pencil"></i>
                                            </span>
				...
				<div class="container">
					<div class="row text-center">
						<div class="col">
							...
							<div class="overflow-hidden mb-3">
								<p class="lead mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">If you have any further questions or queries please do not hesitate to get in touch.</p>
							</div>
						</div>
					</div>
					<div class="row pt-5 pb-4">
						...
						<div class="col-12 col-md-4">
							<div class="icon-box icon-box-style-1 pl-md-3 pl-lg-5 appear-animation" data-appear-animation="fadeInUpShorter">
					...
					<div class="container">
						<div class="row align-items-center justify-content-md-center">
							<div class="col-12 col-lg-4 text-center text-lg-right order-3 order-lg-1">
								<p class="mb-0">Copyrights © 2018 All Rights Reserved by Vschem</p>
							</div>
							<div class="col-12 col-lg-2 text-center order-1 order-lg-2">
								<a href="index.html"><img src="{{asset('app/img/logo-small.png')}}" width="78" height="70" alt="EZY Theme" class="img-fluid" /></a>
							</div>	
		...
		<script src="{{asset('app/vendor/jquery.appear/jquery.appear.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery.easing/jquery.easing.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery-cookie/jquery-cookie.min.js')}}"></script>
		<script src="{{asset('app/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
		<script src="{{asset('app/vendor/common/common.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery.validation/jquery.validation.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery.gmap/jquery.gmap.min.js')}}"></script>
		<script src="{{asset('app/vendor/jquery.lazyload/jquery.lazyload.min.js')}}"></script>
		<script src="{{asset('app/vendor/isotope/jquery.isotope.min.js')}}"></script>
		...
		<script src="{{asset('app/vendor/vide/vide.min.js')}}"></script>
		<script src="{{asset('app/vendor/vivus/vivus.min.js')}}"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="{{asset('app/js/theme.js')}}"></script>
		
		<!-- Current Page app/vendor and Views -->
		<script src="{{asset('app/vendor/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
		<script src="{{asset('app/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
